{ config, pkgs, lib, secrets, ... }:
{
  ...
  accounts.email = {
    ...
    accounts = {
      "marcello.2001@hotmail.com" = {
        primary = true;

        realName = "Marcello Krahforst";
        signature = {
          showSignature = "none";
          text = ''
            Marcello Krahforst
        ...
        address = "marcello.2001@hotmail.com";
        userName = "marcello.2001@hotmail.com";

        imap = {
          host = "imap.hotmail.com";
          port = 993;
        };
        ...
        passwordCommand = "${pkgs.coreutils}/bin/echo ${secrets.email."marcello.2001@hotmail.com".password}";
      };
    };
  };
}
